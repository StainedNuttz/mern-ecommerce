	...
	},
	{
		...
		data: {
			...
			validityRules: {
				...
				[VALIDATE_MIN]: {
					errorMsg: 'Your review must contain at least 5 characters',
					params: 5,
				},
				[VALIDATE_MAX]: {
					errorMsg: 'Your review must contain less than 300 characters',
					params: 300,
				},
			},
		},
...
const ProductViewReview = (props) => {
	...
	const [formState, changeHandler, submitHandler, resetValues] = useForm(
		inputs,
		{ isValid: false },
		submitReview
	)
